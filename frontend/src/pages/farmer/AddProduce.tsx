...
const AddProduce: React.FC = () => {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<ProduceForm>();
  ...
  const onSubmit = async (data: ProduceForm) => {
    setLoading(true);
    try {
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="mt-1 relative">
              ...
              <input
                {...register('availableDate', { required: 'Available date is required' })}
                type="date"
